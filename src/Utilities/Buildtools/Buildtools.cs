...
";
        ...
        {
            runningFileMover.Add(new FileMover(new DirectoryInfo(srcDirectory.Parent.FullName + "\\build"), new DirectoryInfo(srcDirectory.Parent.FullName + "\\build\\sourceMap"), "*.js.map"));
            runningFileMover.Add(new FileMover(new DirectoryInfo(srcDirectory.Parent.FullName + "\\build"), new DirectoryInfo(srcDirectory.Parent.FullName + "\\build\\declaration"), "*.d.ts"));
