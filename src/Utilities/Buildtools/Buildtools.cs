...
namespace Buildtools
{
    public static class Buildtools
    {
        ...
        {
            string configPath = srcDirectory.FullName + filePathSlash + "Utilities" + filePathSlash + "Buildtools.config.json";
...
";
        ...
        private static void AddTscTask(string name, TSConfig.BuildTarget buildTarget, params Configuration.Buildtools.ESVersion[] additionalVersions)
        {
            ...
            for (int i = -1; i < additionalVersions.Length; i++)
            {
                ...
                File.WriteAllText(workingDirectory + filePathSlash + (i == -1 ? "tsconfig" : versionName) + ".json", autoGeneratedFileWarning + JsonConvert.SerializeObject(tsConfig, jsonSerializerSettings));
