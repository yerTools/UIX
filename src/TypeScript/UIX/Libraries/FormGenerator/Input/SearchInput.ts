...
namespace UIX.Libraries.FormGenerator.Input{
    export class SearchInput extends BaseType.TextInputField<SearchInput, HTMLInputElement, "input">{
        ...
        public getHTMLElement(namePrefix?:string, autocompleteSection?:string, autocompleteAddressType?:Helper.InputAutocompleteAddressType){
            if(!this._htmlContainerElement){
                this._htmlInputElement = this.createTextInput("input", true, "search", namePrefix, autocompleteSection, autocompleteAddressType);
        ...
        public clone(){
            return new SearchInput(this.parent, this.name, this.displayName, this.description, this.autofocus, this.autocomplete, this.placeholder, this.pattern, this.minLength, this.maxLength, this.isRequired, this.isReadOnly, this.isDisabled, this.defaultValue, this.sortingPriority);
        }
