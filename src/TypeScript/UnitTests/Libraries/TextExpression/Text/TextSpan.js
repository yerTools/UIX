(() => {
    ...
    const rand = UIX.Libraries.Random.StringGenerator;
    const randNumber = UIX.Libraries.Random.NumberGenerator;

    describe("UIX.Libraries.TextExpression.Text:", () => {
        test("Substring with start.", () => {
            for(let i = 0; i < 2500; i++){
                let text = rand.readable(200);
                let substringStart = randNumber.intBetween(text.length);
        ...
        test("Substring with end.", () => {
            for(let i = 0; i < 2500; i++){
                let text = rand.readable(200);
                let substringEnd = randNumber.intBetween(text.length);
        ...
        test("Substring with start and end.", () => {
            for(let i = 0; i < 2500; i++){
                let text = rand.readable(200);
                let substringStart = randNumber.intBetween(text.length);
                let substringEnd = randNumber.intBetween(text.length, substringStart);
        ...
        test("Substring with random start and end.", () => {
            for(let i = 0; i < 2500; i++){
                let text = rand.readable(200);
                let substringStart = randNumber.intBetween(text.length * 2);
                let substringEnd = randNumber.intBetween(text.length * 2);
        ...
        test("Index of with start index.", () => {
            for(let i = 0; i < 2500; i++){
                ...
                let startIndex = randNumber.intBetween(text.length);
